<%@ Page Language="C#" MasterPageFile="~/cool cab services/maintenanceManger/MaintenanceManger.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="maintenanceManger_ChangePassword" Title="Untitled Page" %>
  ...
  function check()
   {
    ...
    <table align="center" cellpadding="0" cellspacing="5" class="border1" style="position: static"
        ...
        <tr>
            <td align="right"> <font color="red">*</font><span><b>RetypeNewPassword :</b></span>
            </td>
            <td>
