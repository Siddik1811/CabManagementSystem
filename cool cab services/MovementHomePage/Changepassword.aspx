<%@ Page Language="C#" MasterPageFile="~/cool cab services/MovementHomePage/MasterPage.master" AutoEventWireup="true" CodeFile="Changepassword.aspx.cs" Inherits="MovementHomePage_Changepassword" Title="Untitled Page" %>
  ...
  function check()
   {
    ...
    <table align="center" cellpadding="0" cellspacing="5" class="border1" style="position: static"
        ...
        <tr>
            <td align="right"><font color="red">*</font><span><b>Retype NewPassword :</b></span>
            </td>
            <td>
